    ...
    <div className={styles.landingPage}>
      ...
      <section className={styles.stepContainer}>
        <div className={styles.textWrapper}>
          ...
          <p>
            Every location has been selected specifically for their great working environment. This
            means reliable and fast wifi connection, access to amenities like power plugs and
            bathrooms, as well as a cozy and comfy ambient. Cafès, lounges and bars…
          </p>
        </div>
        <div className={styles.imageWrapper}>
      ...
      <section className={styles.stepContainer}>
        <div className={styles.textWrapper}>
          ...
          <p>
            Once you’ve found the perfect place, go ahead and book just for how long you want.
            Half-day, full day, every spot includes different offers based on value and location.
          </p>
        </div>
        <div className={styles.imageWrapper}>
      ...
      <section className={styles.stepContainer}>
        <div className={styles.textWrapper}>
          ...
          <p>
            Whether you’re exploring a new city, or you just want a change of space fo the week, you
            can access different spots and locations to network with new people and try out a
            different life.
          </p>
        </div>
        <div className={styles.imageWrapper}>
