...
const HeaderCities = ({ handleFilterByCity }) => {
  const cities = [
    ...
    },
    {
      ...
      country: 'Netherlands',
      description:
        "Amsterdam is a city and comune in Veneto, northern Italy. Padua is on the river Bacchiglione, west of Venice. It is the capital of the province of Padua. It is also the economic and communications hub of the area. Padua's population is 214,000.",
      img: 'https://image.arrivalguides.com/415x300/02/f2cd31a89b0c335751b11fa8dea987a9.jpg',
    },
  ];
